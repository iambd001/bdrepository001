<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentsignup.aspx.cs" Inherits="dbms_check.studentsignup" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <br />
      <asp:Button ID="btn_ubmit" runat="server" OnClick="btn_ubmit_Click" Text="SUBMIT" />
      <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
