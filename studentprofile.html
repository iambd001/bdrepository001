<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentprofile.aspx.cs" Inherits="dbms_check.studentprofile" %>
...
<div class="wrapper col3">
  <div id="waterwheelCarousel">
    ...
    <img src="images/carousel/11.gif" alt="" />
      <asp:TextBox ID="tbx_studentcourse" runat="server"></asp:TextBox>
      <asp:Button ID="tbn_studentsubmit" runat="server" OnClick="tbn_studentsubmit_Click" Text="SUBMIT" />
  </div>
</div>
<!-- ####################################################################################################### -->
